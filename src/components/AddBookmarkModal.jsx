    ...
    <section className="fixed top-0 right-0 h-screen w-full bg-black/60 dark:bg-neutral900D/50 px-4 flex items-center justify-center z-80">
        <div className="max-w-142.5 w-full rounded-2xl flex flex-col px-4 py-3 gap-6 md:p-8 md:gap-8 bg-neutral0 dark:border dark:bg-neutral800D dark:border-neutral500D relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex flex-col gap-2">
                <h2 className="text-preset1 text-neutral900 dark:text-neutral0">Add a bookmark</h2>
                        <p className="text-preset4m text-neutral800 dark:text-neutral100D">Save a link with details to keep your collection organized. We extract the favicon automatically from the URL.</p>
            ...
            <div className="flex justify-end gap-4">
                        ...
                        <button className="px-4 py-3 rounded-lg bg-teal700 border-image inset-shadow-input text-preset3m text-neutral0">Add Bookmark</button>
