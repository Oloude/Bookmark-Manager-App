    ...
    <section className="w-full min-h-screen flex items-center justify-center px-4 py-20">
        <div className="px-3 py-8 rounded-xl bg-neutral0 flex flex-col gap-8 shadow-login w-full max-w-md md:px-8 md:py-10 dark:border dark:border-neutral500D dark:bg-neutral800D">
            ...
            <div className="space-y-1.5">
                <h1 className="text-preset1 text-neutral900 dark:text-neutral0">Create your account</h1>
                <p className="text-preset4m text-neutral800 dark:text-neutral100D">Join us and start saving your favorite links — organized, searchable, and always within reach.</p>
            </div>
            <form action="" className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                    <label htmlFor="full-name" className="text-preset4m text-neutral900 dark:text-neutral0">Full name *</label>
                    <input type="text" name="" id="full-name" className="p-3 rounded-lg border border-neutral500 bg-neutral0 text-neutral900 text-preset4m inset-shadow-input outline-none dark:bg-neutral600D dark:border-neutral300D dark:text-neutral100D" />
                    <span></span>
                </div>
                <div className="flex flex-col gap-1.5">
                    <label htmlFor="email" className="text-preset4m text-neutral900 dark:text-neutral0">Email address *</label>
                ...
                <button className="text-preset3 text-neutral0 bg-teal700 px-4 py-3 rounded-lg inset-shadow-input border-image dark:text-neutral0">Create account</button>
            </form>
            <div className="flex flex-col gap-3 items-center">
                <p className="text-preset4m text-neutral800 dark:text-neutral100D">Already have an account? <span className="text-neutral900 dark:text-neutral0">Log in</span></p>
            </div>
