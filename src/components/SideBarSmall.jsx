    ...
    <div className='flex flex-col w-74 bg-neutral0 border border-neutral300 gap-4 h-full'>
        ...
        <section className="px-4 pb-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-col ">
                    {
                        [1,2,3].map((num, i)=> (<div key={i} className="my-0.5 px-3 py-2 rounded-md bg-neutral0 flex items-center justify-between">
                            <label htmlFor="" className="flex items-center gap-2 text-preset3m text-neutral800"><input type="checkbox" name="" id="" /> Ai</label>
                            <div className="px-2 py-0.5 flex items-center justify-between text-preset5 text-neutral800 rounded-full bg-neutral100 border border-neutral300 w-5.25 h-5.25">{num}</div>
